...
const CarNewForm = ({cartype,carenginetype,createCar}:{cartype:any, carenginetype:any,createCar:any}) => {
...
<form onSubmit={form.handleSubmit(onSubmit)}>
  ...
  <div className="flex flex-col md:flex-row md:space-x-4">
    <label className="w-full md:w-full">
      ...
      <Input {...form.register('registration_number')}/>    </label>
  </div>
      ...
      <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              return <SelectItem key={engineType?.id} value={`${engineType?.id}`}>{engineType?.engine_type}</SelectItem>
...
<FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              return <SelectItem key={carlist?.id} value={`${carlist?.id}`}>{carlist?.type_name}</SelectItem>
