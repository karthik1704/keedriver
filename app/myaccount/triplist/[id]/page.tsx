  ...
  <div className="w-11/12 flex flex-col justify-center gap-3 mt-5">
    <div className="text-lg">
      ...
      <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2 flex items-center">
        ...
        <span className="inline-block">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, repellendus!</span>
      </p>
    </div>
    ...
    <div className="text-lg">
      ...
      <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2 flex items-center">
        <Landmark className="inline-block mr-2 text-red-600" />address
      </p>
    </div>
      ...
      <div className="text-lg grid sm:grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          ...
          <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2">
            <Calendar className="inline-block mr-2 text-red-600" />06/09/2024
          </p>
        </div>
        <div>
          <span className="text-white">Trip Time</span>
          <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2">
            <Clock className="inline-block mr-2 text-red-600" />10:30 am
          </p>
        </div>
        <div>
          <span className="text-white">Trip Type</span>
          <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2">
            <Route className="inline-block mr-2 text-red-600" />round trip
          </p>
        </div>
        <div>
          <span className="text-white">Phone Number</span>
          <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2">
            <Phone className="inline-block mr-2 text-red-600" />9003209825
          </p>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="text-lg grid sm:grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          ...
          <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2">
            <User className="inline-block mr-2 text-red-600" />Ajin Kumar
          </p>
        </div>
        <div>
          <span className="text-white">Phone Number</span>
          <p className="bg-white p-2 text-md text-gray-700 rounded-lg mt-2">
            <Phone className="inline-block mr-2 text-red-600" />9001234221
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="w-full">
      <h3 className="text-xl mb-4 font-semibold text-white text-center">Car Details</h3>
      <ul className="w-full bg-white rounded-lg grid lg:grid-cols-3 items-center gap-2 p-3">
        <li className="w-full">
          <span className="mb-3 inline-block font-bold border-b-2 border-rose-700 pb-1">Car Name</span>
        ...
        <li className="w-full">
          <span className="mb-3 inline-block font-bold border-b-2 border-rose-700 pb-1">Car Model</span>
          <div className="flex gap-3 text-gray-700 rounded-lg">
        ...
        <li className="w-full">
          <span className="mb-3 inline-block font-bold border-b-2 border-rose-700 pb-1">Registration No</span>
          <div className="flex gap-3 text-gray-700 rounded-lg">
        ...
        <li className="w-full">
          <span className="mb-3 inline-block font-bold border-b-2 border-rose-700 pb-1">Gear Type</span>
          <div className="flex gap-3 text-gray-700 rounded-lg">
        ...
        <li className="w-full">
          <span className="mb-3 inline-block font-bold border-b-2 border-rose-700 pb-1">Gas</span>
          <div className="flex gap-3 text-gray-700 rounded-lg">
    ...
    <div className="mb-3">
      <h3 className="text-xl mb-4 font-semibold text-white text-center">Trip Amount</h3>
